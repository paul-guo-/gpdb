...
CREATE FUNCTION gp_terminate_mpp_backends(int4, bool) RETURNS bool LANGUAGE INTERNAL VOLATILE PARALLEL RESTRICTED AS 'gp_terminate_mpp_backends' WITH (OID = 6999, DESCRIPTION="terminate all mpp backends on the segment");
